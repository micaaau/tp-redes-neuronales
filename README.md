# TP Matemática III - Redes Neuronales
...
| Parte | Descripción |
|-------|-------------|
| Parte 1 | Análisis exploratorio del dataset (EDA) |
| Parte 2 | Red neuronal implementada solo con `numpy` |
| Parte 3 | Comparación con `scikit-learn` |
| Parte 4 | Conclusiones (ver informe PDF) |
